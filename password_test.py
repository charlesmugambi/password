...
class TestCredentials(unittest.TestCase):
    '''
    Test class that defines the test cases for creating and authenticating the credentials
    '''
    ...
    def setUp(self):
        ...
        '''
        self.new_user = Credentials(1, "charles", "angela.")
    def test_init(self):
        '''
        ...
        self.assertEqual(self.new_user.password, "angela.")
...
class TestUserData(unittest.TestCase):
    ...
    def setUp(self):
        ...
        Setting up the structure before each test
        '''
        self.new_data = UsersInfo(1, 1, "gmail.com", "charlesmugambi")
    ...
    def test_init(self):
        ...
        self.assertEqual(self.new_data.web_pass, "charlesmugambi")
    ...
    def test_display_data(self):
        ...
        '''
        self.new_data.add_password()
        test_data = UsersInfo(1, 1, "gmail.com", "charlesmugambi")
